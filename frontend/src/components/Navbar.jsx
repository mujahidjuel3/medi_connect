...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4 mb-5 text-sm border-b-2 border-b-gray-400'>
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                <div className='relative flex items-center gap-2 cursor-pointer group'>
                    ...
                    <div className='flex flex-col gap-4 p-4 rounded min-w-48 bg-stone-100'>
                        ...
                        <p onClick={()=>navigate('my-apoinment')} className='cursor-pointer hover:text-black'>My Apoinments</p>
            ...
            <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-2 px-5 mt-5 text-lg font-medium'>
                    ...
                    <NavLink  onClick={()=>setShowMenu(false)} to='/contact'><p className='inline-block px-4 py-2 rounded'>CONTACT</p></NavLink>
                </ul>
            </div>
        </div>
    </div>
